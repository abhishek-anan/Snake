...
class Main:
    ...
    def draw_score(self):
        ...
        if int(self.high_score) < int(score_text):
            self.high_score = score_text
        score_surface = game_font.render(score_text,True,(0,0,0))
        score_x = int(cell_number + 100)
        score_y = int(cell_number + 20)
        score_rect = score_surface.get_rect(center = (score_x,score_y))
        screen.blit(score_surface,score_rect)

        score_surface2 = game_font.render("SCORE :",True,(0,0,0))
        score_rect2 = score_surface2.get_rect(center = (score_x-50,score_y))
        screen.blit(score_surface2,score_rect2)

        high_surface = game_font.render("High SCORE :",True,(0,0,0))
        score_rect3 = high_surface.get_rect(center = (score_x-50,score_y+20))
        screen.blit(high_surface,score_rect3)

        high_surface2 = game_font.render(self.high_score,True,(0,0,0))
        score_rect4 = high_surface2.get_rect(center = (score_x+10,score_y+20))
        screen.blit(high_surface2,score_rect4)
